...
public class PlayerScript : MonoBehaviour
{
	...
	private void MouseMove()
	{
        ...
        {
			XRRig.gameObject.transform.eulerAngles = XRRig.gameObject.transform.eulerAngles + Vector3.up * Input.GetAxis("XRI_Right_Primary2DAxis_Horizontal") * this.mouseSensitivity * Time.timeScale * this.flipaturn;
            //this.CameraRotation.eulerAngles = this.CameraRotation.eulerAngles + Vector3.up * Input.GetAxis("XRI_Right_Primary2DAxis_Horizontal") * this.mouseSensitivity * Time.timeScale * this.flipaturn;
        }
        this.playerRotation.eulerAngles = new Vector3(0, this.CameraRotation.eulerAngles.y, this.fliparoo);
