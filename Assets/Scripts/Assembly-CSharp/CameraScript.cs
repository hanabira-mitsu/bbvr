...
public class CameraScript : MonoBehaviour
{
	...
	private void LateUpdate()
	{
		...
		if (!this.ps.gameOver & !this.ps.jumpRope)
		{
            ...
            this.player.transform.rotation = this.player.transform.rotation * Quaternion.Euler(0f, (float)this.lookBehind, 0f); //Rotate player based on camera direction + lookbehind
		}
